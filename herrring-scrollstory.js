...
function boot(root, host, opt) {
  ...
  function start() {
    ...
    fitHeight(host, opt.scrollHeight);
    ...
    if (span <= 0) {
      console.warn("[scrollstory] Keine Scrollstrecke: Elementhöhe " +
        Math.round(host.getBoundingClientRect().height) + "px, Fenster " +
        innerHeight + "px. Sektion im Wix-Editor auf automatische Höhe stellen.");
    }
